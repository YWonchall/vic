...
train_pipeline = [
    ...
    dict(
        ...
        db_sampler=dict(
            ...
            info_path=
            '../dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure-example/vehicle-side/kitti_dbinfos_train.pkl',
            rate=1.0,
            prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            '../dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure-example/vehicle-side',
            ann_file=
            '../dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure-example/vehicle-side/kitti_infos_train.pkl',
            split='training',
    ...
    val=dict(
        ...
        '../dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure-example/vehicle-side',
        ann_file=
        '../dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure-example/vehicle-side/kitti_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
        pipeline=[
            dict(
