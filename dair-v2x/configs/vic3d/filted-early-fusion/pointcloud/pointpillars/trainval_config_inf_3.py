...
log_level = "INFO"
load_from = "/workspace/vic-competition/dair-v2x/configs/vic3d/late-fusion-pointcloud/pointpillars/vic3d_latefusion_inf_pointpillars_596784ad6127866fcfb286301757c949.pth"
resume_from = None
workflow = [("train", 1)]
gpu_ids = range(0, 1)
