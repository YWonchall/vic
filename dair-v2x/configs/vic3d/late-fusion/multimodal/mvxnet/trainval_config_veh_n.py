...
data_root = "/workspace/vic-competition/dair-v2x/data/DAIR-V2X/cooperative-vehicle-infrastructure-example/vic3d-early-fusion-training"
class_names = ["Car"]
...
lr_config = dict(policy="step", step=[3,6,12], warmup=None, warmup_iters=1000, warmup_ratio=0.1)
...
log_level = "INFO"
work_dir = "/workspace/vic-competition/mmdetection3d/work-dirs/exam-c/veh-car"
load_from = '/workspace/vic-competition/dair-v2x/configs/vic3d/late-fusion-multimodal/mvxnet/mvxnet_veh_my.pth' #"https://download.openmmlab.com/mmdetection3d/v1.0.0_models/mvxnet/dv_mvx-fpn_second_secfpn_adamw_2x8_80e_kitti-3d-3class/dv_mvx-fpn_second_secfpn_adamw_2x8_80e_kitti-3d-3class_20210831_060805-83442923.pth"
