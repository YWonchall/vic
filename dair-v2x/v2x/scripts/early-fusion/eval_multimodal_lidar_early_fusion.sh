...
rm -r ../cache
# 2 使用单类需要注意类别处理
INFRA_MODEL_PATH="../configs/vic3d/filted-early-fusion/custom/pointpillars-mvxnet"
...
# 3
VEHICLE_MODEL_PATH="../configs/vic3d/filted-early-fusion/custom/pointpillars-mvxnet"
VEHICLE_CONFIG_NAME="trainval_config_veh_3.py"
VEHICLE_MODEL_NAME="mvxnet_veh_3_vic_veh.pth"
# 4
